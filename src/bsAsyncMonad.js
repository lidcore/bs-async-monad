...
function ensure($staropt$star, current, ensure$1, cb) {
  ...
  return Curry._1(current, (function (err, ret) {
                return on_next(noStack, (function () {
                              return Curry._2(ensure$1, /* () */0, (function (param, param$1) {
                                            return cb(err, ret);
                                          }));
                            }));
              }));
...
function discard(fn, cb) {
  return Curry._1(fn, (function (err, param) {
                return cb(err, /* () */0);
              }));
}
...
function repeat_unless(condition, computation) {
  var condition$1 = function (param, cb) {
    return Curry._2(condition, /* () */0, (function (err, ret) {
                  return cb(err, !ret);
                }));
  };
...
function itera($staropt$star, fn, a, cb) {
  ...
  var $$process = function (param) {
    var match = a.shift();
    if (match !== undefined) {
      return Curry._2(fn, match, (function (err, param) {
                    if (err == null) {
...
function resolvea($staropt$star, concurrency, a) {
  var resolver = $staropt$star !== undefined ? $staropt$star : (function (param) {
        return (function (param) {
            return param(null, /* () */0);
          });
      });
  ...
  var wrap = function (fn) {
    ...
    var wrap$1 = function (cb) {
      return (function (err, ret) {
          cb(err, ret);
          if (err == null) {
            return Curry._2(resolver, ret, (function (param, param$1) {
    ...
    var resolve = function (param) {
      ...
      if (match !== undefined) {
        return Curry._1(fn, Caml_option.valFromOption(match));
      } else {
        can_resolve[0] = true;
        return /* () */0;
      }
    ...
    var fn$1 = function (cb) {
      if (can_resolve[0]) {
        ...
        callback[0] = Caml_option.some(wrap$1(cb));
        return /* () */0;
      }
    };
    return /* tuple */[
...
function finish(exceptionHandler, t) {
  return execute(exceptionHandler, t, (function (param) {
                return /* () */0;
              }));
}
...
function Make(Wrapper) {
  ...
  var ensure$1 = function (noStack, p, fn) {
    var c = Curry._1(Wrapper[/* to_callback */2], p);
    return Curry._1(Wrapper[/* from_callback */3], (function (param) {
                  return ensure(noStack, c, (function (param) {
  ...
  var discard = function (p) {
    return compose$1(undefined, p, (function (param) {
  ...
  var async_if$1 = function (cond, computation) {
    ...
    var computation$1 = function (param) {
  ...
  var finish = function (exceptionHandler, p) {
    return execute$1(exceptionHandler, p, (function (param) {
                  return /* () */0;
                }));
  };
  return /* module */[
